...
if(!isset($_SESSION['username']) or !isset($_SESSION['password']) == true){
    ...
    <div class="container">
      <div class="row">
                  <div class="col-md-12">
                              ...
                              <h3>Approve below donated time? Enter transaction ID</h3>
                             
                              <input type="radio" name="is_approved" value="Approved">Approve <br>   
                              <input type="radio" name="is_approved" value="Denied">Reject<br> 
                              <input type="submit" name="submit">
                              </form>
...
$sql = "SELECT  dayDate, donationStart, officeManager FROM donate WHERE user_id = '$user_id' ";
$result= $conn->query($sql);

if($result->num_rows > 0 ){
  while ($row = $result->fetch_assoc()) {
    echo "<h3>Donated time</h3>"."Submited on: " . $row["dayDate"]. "<br>" .
    "Donated Days ". $row["donationStart"]. "<br>".
...
$sql2 = "UPDATE donate SET is_approved = '$is_approved' WHERE user_id = '$user_id'";
