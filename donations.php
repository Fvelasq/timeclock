...
$sql = "SELECT  dayDate, donationStart, is_approved, officeManager FROM donate WHERE user_id = '$user_id' ";
$result= $conn->query($sql);

if($result->num_rows > 0 ){
  while ($row = $result->fetch_assoc()) {
    echo "<h3>Someone donated time to you</h3>"."Submited on: " . $row["dayDate"]. "<br>" .
    "Donated Days ". $row["donationStart"]. "<br>".
    "Approval Status = ". $row["is_approved"]. "<br>".
