...
$user_id = $_POST['user_id'];
$officeManager = $_POST['officeManager'];
$donationStart = $_POST['donationStart'];
			...
			<div class="row">
                  <div class="col-md-12">
                              ...
                              <form method="post" action="">
                                <br><br><br>
                              <h2>Donate your time to employee below:</h2> 
                              <h3>Canditate Employee ID</h3>
                              ...
                              <h3>Donation time in days</h3>
                              <input type="number" name="donationStart" value="">
                              <h3>Donation ID</h3>
                              <input type="number" name="transactionID" value="">
...
if ($conn->connect_error) {
  ...
  $sql = "INSERT INTO donate (dayDate, donationStart, user_id, officeManager, transactionID) VALUES ('$dayDate','$donationStart', '$user_id', '$officeManager', '$transactionID')" or die("Error in loggin process"); 
